            ...
            switch (c) {
                ...
                case 2:
                    ...
                    if (account.deposit(depositAmount)) {
                        System.out.println("New Balance: PHP " + account.getBalance());
                    }
                    break;
                case 3:
                    ...
                    if (account.withdraw(withdrawAmount)) {
                        ...
                        System.out.println("Current Balance: PHP" + account.getBalance());
                    }
                    break;
                case 0:
                    System.out.println("Thank you for using. Logging out...");
                    running = false;
                    break;
                default:
